        ...
        <div className={styles.content}>
          ...
          >
            <p className={styles.paragraph}>
              ...
              in frontend engineering, I specialize in building{" "}
              <span className={styles.highlight}>
                scalable React applications
              </span>
              , reusable UI component systems, and performance-optimized
              interfaces.
            </p>
            <p className={styles.paragraph}>
              My engineering philosophy centers on{" "}
              <span className={styles.highlight}>clean architecture</span>,{" "}
              <span className={styles.highlight}>thoughtful abstractions</span>,
              and obsessive attention to user experience. I believe great
              frontends are not just beautiful — they are fast, accessible, and
              maintainable.
            </p>
